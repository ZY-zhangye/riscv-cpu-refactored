...
module tb_a7_perf_profile;
    ...
    task automatic check_window_invariants;
        ...
        begin
            ...
            if (dual_launches != class_launches) begin
                $fatal(1,
                       "A7 profile launch identity failed: launch=%0d simple_pair=%0d simple_single=%0d control1=%0d control0=%0d lsu=%0d muldiv=%0d",
    ...
    task automatic print_window(input integer report_index);
        begin
            $display("A7_PROFILE_WINDOW index=%0d name=%s cycles=%0d instret=%0d issue_pair=%0d issue_single=%0d imem_req=%0d packets=%0d fetch_uops=%0d single_packet=%0d fetch_empty=%0d dual_launch=%0d simple_pair=%0d simple_single=%0d control1_pair=%0d control1_csr=%0d control0_pair=%0d control0_kill=%0d lsu_pair=%0d muldiv_pair=%0d retire1=%0d retire2=%0d legacy_pair=%0d legacy_prefer=%0d legacy_nonprefer=%0d wait_legacy=%0d wait_dual=%0d",
    ...
    final begin
        $display("A7_PROFILE_TOTAL windows=%0d imem_req=%0d packets=%0d fetch_uops=%0d single_packet=%0d fetch_empty=%0d dual_launch=%0d simple_pair=%0d simple_single=%0d control1_pair=%0d control0_pair=%0d control0_kill=%0d retire1=%0d retire2=%0d legacy_pair=%0d legacy_prefer=%0d legacy_nonprefer=%0d wait_legacy=%0d wait_dual=%0d",
