...
module timer (
    ...
    assign timer_reload           = timer_ctrl[3];  // periodic reload enable
    assign timer_prescaler_enable = timer_ctrl[4];

    assign prescaler_pulse = !timer_prescaler_enable ||
                             (prescaler_count >= timer_prescaler);

    assign timer_step = timer_enable && prescaler_pulse;
