...
`define FETCH_EPOCH_WIDTH 2
`define FETCH_AGE_WIDTH 32
`define FETCH_UOP_WIDTH (`FETCH_EPOCH_WIDTH+`FETCH_AGE_WIDTH+32+32+1+32+`BP_TYPE_WIDTH+1+1+32)
`define ISSUE_BUNDLE_WIDTH (2+(2*`FETCH_UOP_WIDTH))
`define PAIR_CLASS_WIDTH 3
`define PAIR_NONE           3'd0
`define PAIR_SIMPLE_SIMPLE  3'd1
`define PAIR_SIMPLE_CONTROL 3'd2
`define PAIR_SIMPLE_LSU     3'd3
...
`ifdef Z_BITMAIN_ENABLE
    ...
    `define CTRL_PACKET_WIDTH (32+32+2+7+5+3)
`else
    `define BITMAN_PACKET_WIDTH 0
    `define CTRL_PACKET_WIDTH (32+32+2+6+5+3)
`endif
...
`define ES_MS_WIDTH (32+32+32+32+4+32+6+5+1+1+2+1+12+32)
...
`define MS_WS_WIDTH (32+32+32+5+1+1+1+12+32)
...
`define CSR_PERF_BRMISP 12'h7C4
...
`define CSR_PERF_DUAL_ISSUE 12'h7CA
`define CSR_PERF_SINGLE_ISSUE 12'h7CB
`define CSR_PERF_ISSUE_RAW 12'h7CC
