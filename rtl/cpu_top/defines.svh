...
`define ES_MS_WIDTH (32+32+32+6+4+32+5+1+1+2+1+12+32)
...
`define CSR_PERF_LSU_PAIR 12'h7CF
`define CSR_PERF_LANE1_CTRL 12'h7D0
`define CSR_PERF_LSU_CONFLICT 12'h7D1
`define CSR_PERF_BITMAN_PAIR 12'h7D2
