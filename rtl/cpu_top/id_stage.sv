...
module id_stage #(
    ...
    input logic reg_fpu_wen1,
    input logic [4:0] regfile_waddr1,
    input logic [`DATA_WIDTH-1:0] regfile_wdata1,
    ...
    input logic secondary_ms_valid,
    //跳转信号与异常信号
